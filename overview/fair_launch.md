...
It will set out the philosophy behind how Proxima starts: the role of the bootstrap
capital, how the network passes out of the founder's hands as mining proceeds, and what
has to be true before Proxima can be called decentralized.

Until it is written, the mechanics are covered elsewhere:
