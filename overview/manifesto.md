...
There are no blocks, no proposers, no validators, and no global mempool. Every token holder writes the ledger through deterministic validity constraints. **This restores write access as a universal right rather than a privilege gated by committees, leader elections, or validator roles.** The protocol is largely defined by transaction validity rules alone.
