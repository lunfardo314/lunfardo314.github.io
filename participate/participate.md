...
The launch is a **fair launch**. There is no presale, no allocation, no investor round, no treasury. Six per cent of the supply is minted at genesis, as the bootstrap capital that gets the ledger moving. The other **94 % is mined**, with proof of work, by whoever competes for it: nobody hands those tokens out, a miner mints them by satisfying rules fixed at genesis. See [The fair launch](overview/fair_launch.md).
